                ...
                <header class="project-summary-header border-b border-slate-100 pb-5">
                    <div class="project-summary-title">
                        ...
                        <div class="mt-2 flex items-center gap-3">
                            ...
                            <div><h2 class="text-2xl font-bold">{{ $selectedProject->product_name }}@if($selectedProject->keywords) · {{ $selectedProject->keywords }}@endif</h2><p class="mt-1 text-sm text-slate-500">当前环节：{{ $labels[$selectedProject->current_stage] ?? $selectedProject->current_stage }}</p></div>
                        </div>
                    </div>
