...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/profit-calculator', [ProfitCalculatorController::class, 'saveNew'])->name('profit-calculator.save-new');
    ...
    Route::delete('/projects/{project}/creative-assets/{asset}', [CreativeAssetController::class, 'destroy'])->name('projects.creative-assets.destroy');
